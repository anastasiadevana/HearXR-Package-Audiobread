...
{
    [CustomEditor(typeof(ToneGeneratorDefinition), true)]
    public class ToneGeneratorDefinitionEditor : SoundDefinitionEditor
    {
...
//     
//             SerializedProperty frequencyProp = serializedObject.FindProperty("_frequency");
...
//             //
//             // var frequencyPropValue = frequencyProp.floatValue;
//             // frequencyPropValue = EditorGUI.FloatField(position, "Freq", frequencyPropValue);
//             // //position.x += position.width + _horizontalSpacer + 20;
//             // position.x = EditorGUIUtility.labelWidth + 5;
//             
//             position.width = 36;
//             EditorGUI.LabelField(position, "Freq");
...
//             
//             var frequencyPropValue = frequencyProp.floatValue;
//             frequencyPropValue = EditorGUI.FloatField(position, frequencyPropValue);
//             
//             position.x = EditorGUIUtility.labelWidth + 5;
//     
//             
...
//                 frequencyProp.floatValue = frequencyPropValue;
//             }
//             
